...
public class AdapterButtonJam7 extends RecyclerView.Adapter<AdapterButtonJam7.ViewHolder> {
    ...
    public AdapterButtonJam7(Context context, ArrayList<Integer> arrayJumlah, int kuotaMax, int kuotaPerjam,
    ...
    @NonNull
    @Override
    public AdapterButtonJam7.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.button_nomor, null);

        return new AdapterButtonJam7.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterButtonJam7.ViewHolder viewHolder, final int position) {
