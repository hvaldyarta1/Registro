...
public class AdapterButtonJam6 extends RecyclerView.Adapter<AdapterButtonJam6.ViewHolder> {
    ...
    public AdapterButtonJam6(Context context, ArrayList<Integer> arrayJumlah, int kuotaMax, int kuotaPerjam,
    ...
    @NonNull
    @Override
    public AdapterButtonJam6.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.button_nomor, null);

        return new AdapterButtonJam6.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterButtonJam6.ViewHolder viewHolder, final int position) {
