...
public class AdapterButtonJam8 extends RecyclerView.Adapter<AdapterButtonJam8.ViewHolder> {
    ...
    public AdapterButtonJam8(Context context, ArrayList<Integer> arrayJumlah, int kuotaMax, int kuotaPerjam,
    ...
    @NonNull
    @Override
    public AdapterButtonJam8.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.button_nomor, null);

        return new AdapterButtonJam8.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterButtonJam8.ViewHolder viewHolder, final int position) {
