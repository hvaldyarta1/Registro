...
public class AdapterButtonJam10 extends RecyclerView.Adapter<AdapterButtonJam10.ViewHolder> {
    ...
    public AdapterButtonJam10(Context context, ArrayList<Integer> arrayJumlah, int kuotaMax, int kuotaPerjam,
    ...
    @NonNull
    @Override
    public AdapterButtonJam10.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.button_nomor, null);

        return new AdapterButtonJam10.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterButtonJam10.ViewHolder viewHolder, final int position) {
