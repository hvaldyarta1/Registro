...
public class AdapterButtonJam9 extends RecyclerView.Adapter<AdapterButtonJam9.ViewHolder> {
    ...
    public AdapterButtonJam9(Context context, ArrayList<Integer> arrayJumlah, int kuotaMax, int kuotaPerjam,
    ...
    @NonNull
    @Override
    public AdapterButtonJam9.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.button_nomor, null);

        return new AdapterButtonJam9.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterButtonJam9.ViewHolder viewHolder, final int position) {
