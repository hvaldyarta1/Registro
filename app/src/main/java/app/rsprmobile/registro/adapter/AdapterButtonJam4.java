...
public class AdapterButtonJam4 extends RecyclerView.Adapter<AdapterButtonJam4.ViewHolder> {
    ...
    public AdapterButtonJam4(Context context, ArrayList<Integer> arrayJumlah, int kuotaMax, int kuotaPerjam,
    ...
    @NonNull
    @Override
    public AdapterButtonJam4.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.button_nomor, null);

        return new AdapterButtonJam4.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterButtonJam4.ViewHolder viewHolder, final int position) {
